              ...
              {[
                {
                  ...
                  description:
                    "Muestras de proyectos y experimentos de los niños.",
                ...
                <li className="ev-slide" key={i}>
                  <article className="ev-card">
                    <div className="ev-card-media">
                      {ev.image ? (
                        <img src={ev.image} alt="" aria-hidden="true" />
                      ) : (
                        <div className="ev-card-fallback" />
                      )}
                    </div>
